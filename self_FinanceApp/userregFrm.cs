    ...
    {                
        ...
        public void accountcreated()
        {
            try
            {
                ...
                string sqlquery = ("insert into db_auth(Entry_no,Username,Name,Password,Gender,Contact_no,Email,Account_Creation_Date)values('" + txtentry.Text + "','" + txtUsername.Text + "','" + txtName.Text + "','" + txtPass.Text + "','" + CmboGender.Text + "','" + txtEmail.Text + "','" + txtContact.Text + "','" + txtDate.Text + "')");
        ...
        private void autogenerated ()
        {
            try
            {
                ...
                str = "select MAX(Entry_no) from db_auth";
                com = new SqlCommand(str, con);
                con.Open();
                count = Convert.ToInt16(com.ExecuteScalar()) + 1;
                txtentry.Text = count.ToString();
